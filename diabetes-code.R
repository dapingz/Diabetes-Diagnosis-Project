# "Diabetes Diagnosis Project" by Daping Zhang (June 10, 2022)
...
# We will do some analysis and necessary pro-processing on the dataset, then try 
# to build some models using some methods and compare them with the accuracy of 
# predictions. Finally, a model with the highest prediction accuracy is selected.
...
# there 768 outcomes in the dependent dataset (target variable)
length(diab_y) 
